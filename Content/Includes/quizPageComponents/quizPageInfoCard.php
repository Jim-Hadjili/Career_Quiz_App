<div class="flex flex-wrap md:flex-nowrap items-start gap-6 md:gap-8 w-full">
    <!-- Icon Section -->
    <div class="w-16 h-16 md:w-20 md:h-20 bg-dark rounded-2xl flex items-center justify-center shadow-lg border-2 border-dark flex-shrink-0 mb-4 md:mb-0 mx-auto md:mx-0">
        <i class="fas fa-lightbulb text-lime text-3xl md:text-4xl"></i>
    </div>
    ...
    <div class="flex-1 min-w-[220px]">
        <div class="flex flex-wrap items-center gap-3 mb-3">
            <?php if ($is_registered): ?>
                <span class="bg-dark text-lime px-4 py-1.5 rounded-full text-sm font-semibold flex items-center gap-2 border-2 border-dark shadow-sm font-sans">
                    <i class="fas fa-user-check"></i> Registered
                </span>
            <?php else: ?>
                <span class="bg-cream text-dark px-4 py-1.5 rounded-full text-sm font-semibold flex items-center gap-2 border-2 border-border shadow-sm font-sans">
