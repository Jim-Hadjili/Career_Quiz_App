...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2025 at 03:21 PM
...
(1, 'Admin', 'admin@gmail.com', 'Admin', '$2y$10$bPwcxJ7Uzm1rBx3TMhaAye.yR2V7CykSkHzZRLfwcH/hbpFeXisDC', '2025-11-01 21:58:31');
...
--
ALTER TABLE `selected_career_tb`
  MODIFY `selectedCareer_id` int(11) NOT NULL AUTO_INCREMENT;
