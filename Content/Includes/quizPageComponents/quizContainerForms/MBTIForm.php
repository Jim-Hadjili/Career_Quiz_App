<div id="mbti-form" class="bg-white rounded-2xl shadow-lg p-8 border-2" style="display: none;">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-gray-600 text-lg font-sans max-w-2xl mx-auto">
            Complete your profile by selecting your MBTI personality type. This helps us match you with careers that
            align with your natural preferences and work style.
        </p>
    </div>
    ...
    <div class="flex justify-center mb-8">
        <div class="flex items-center space-x-4 bg-cream/50 rounded-full px-6 py-3 border border-border">
            ...
            <div class="w-12 h-0.5 bg-crimson_red"></div>
            <div class="flex items-center space-x-2">
                <div class="w-8 h-8 bg-crimson_red rounded-full flex items-center justify-center">
                    <i class="fas fa-check text-white text-sm"></i>
                </div>
            ...
            <div class="flex items-start space-x-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 font-sans leading-relaxed">
                        Take a free personality test to discover your personality type. <a
                            href="https://www.16personalities.com/free-personality-test" target="_blank"
                            class="inline-flex items-center mt-3 text-sm font-medium text-dark hover:text-navy_blue transition-colors duration-200 underline underline-offset-2 hover:underline-offset-4 font-sans">
                            Take Free Test
    ...
    <div class="flex flex-col sm:flex-row justify-between items-center gap-4 pt-6 border-t border-gray-200">
        <button id="back-to-grades-btn" type="button"
        ...
        <div class="flex items-center space-x-4">
            ...
            <!-- Complete Button -->
            <button id="complete-quiz-btn" type="button"
                class="px-6 py-3 bg-navy_blue text-white font-bold rounded-xl border-2 hover:bg-dark hover:text-white transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-dark disabled:hover:text-white shadow-lg font-sans flex items-center group"
                disabled>
                Generate Results
