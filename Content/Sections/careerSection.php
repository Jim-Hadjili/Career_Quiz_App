    ...
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
                <span class="bg-light_gray text-crimson_red px-4 py-2 rounded-lg inline-block">Career Paths</span>
            </h2>
        ...
        <div class="relative">
            ...
            <div class="flex justify-center items-center gap-4 mt-6 md:hidden">
                <button id="prevBtn"
                    class="bg-crimson_red text-white w-12 h-12 rounded-full flex items-center justify-center shadow-lg hover:bg-red-600 hover:text-white transition-all duration-300 hidden">
                    <i class="fas fa-chevron-left"></i>
                </button>
                <button id="nextBtn"
                    class="bg-crimson_red text-white w-12 h-12 rounded-full flex items-center justify-center shadow-lg hover:bg-red-600 hover:text-white transition-all duration-300">
