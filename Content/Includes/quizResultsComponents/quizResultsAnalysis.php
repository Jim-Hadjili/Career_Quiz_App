<section class="pt-24 pb-8 bg-white" id="Personality-Type">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                    ...
                    <h2
                        ...
                        id="banner-personality-type">
                        INTP
                    </h2>
                    <p class="text-2xl opacity-90" id="banner-personality-full">
                        INTP - The Thinker
                    </p>
                </div>
                <div class="text-center">
                    <div
                        class="inline-flex items-center justify-center w-32 h-32 bg-white/20 rounded-full mb-6">
                        <i class="fas fa-brain text-6xl"></i>
                    </div>
                    <p class="text-lg font-medium">Personality Character</p>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <p
                class="text-sm text-gray-600 uppercase tracking-wide font-bold">
                — ALBERT EINSTEIN
            </p>
        </div>
        ...
        <div
            ...
            <img
                ...
                class="max-w-full h-auto max-h-80 rounded-2xl" />
        </div>
    </div>
</section>