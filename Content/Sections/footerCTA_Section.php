            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="flex flex-col items-center text-center">
                    ...
                    <p class="text-base md:text-md lg:text-lg text-gray-600 mb-8 max-w-2xl">
                        <?php if ($isLoggedIn): ?>
                        Great! You're all set to discover your ideal career direction. Let's find out what path suits
                        you best.
                        <?php else: ?>
                        Join thousands of students who have discovered their ideal career direction. Your future starts
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center w-full">
                        <button type="button" onclick="startQuiz()"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 group-hover:translate-x-1 transition-transform duration-300 relative z-10"
                        ...
                        <button type="button" onclick="openSignUpModal()"
                            class="group relative inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-dark border-2 border-dark font-medium rounded-xl transition-all duration-300 shadow-lg hover:bg-navy_blue hover:text-white hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-lime-500/30 focus:ring-offset-2 w-full md:w-auto transform hover:scale-105 overflow-hidden text-base md:text-sm lg:text-base"
                            aria-label="Create Account">
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-black/0 via-black/10 to-black/0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000">
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 group-hover:rotate-12 transition-transform duration-300 relative z-10"
                                viewBox="0 0 20 20" fill="currentColor">
                                <path
                                    d="M10 10a4 4 0 100-8 4 4 0 000 8zm0 2c-3.314 0-6 1.343-6 3v1a1 1 0 001 1h10a1 1 0 001-1v-1c0-1.657-2.686-3-6-3z" />
                            </svg>
                    ...
                    <div
                        class="mt-8 flex items-center justify-center space-x-6 text-xs md:text-xs lg:text-sm text-gray-500">
                        <?php if ($isLoggedIn): ?>
                        <div class="flex items-center space-x-2">
                            <i class="fas fa-check-circle text-crimson_red"></i>
                ...
                <div class="relative hidden lg:block">
                    <div class="bg-white rounded-3xl p-8 border-2 border-dark shadow-lg">
                        <img src="https://illustrations.popsy.co/amber/success.svg" alt="Career Success Illustration"
                            class="w-full h-[350px] mb-6">
                    </div>
                </div>
            </div>
        </div>
