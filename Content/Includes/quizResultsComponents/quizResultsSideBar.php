<aside
    ...
    <div class="mb-6">
        <div class="flex items-center mb-4">
            <div class="w-12 h-12 rounded-full bg-crimson_red flex items-center justify-center mr-4 shadow-lg">
            ...
            <div>
                ...
                <h3 class="text-lg font-bold text-gray-800" id="sidebar-personality-type">
                    INTP
                </h3>
    ...
    <!-- Divider -->
    <div class="h-1 bg-navy_blue rounded-full mb-6"></div>

    <!-- Navigation -->
    <div class="mb-6">
        <p class="text-xs font-bold text-gray-600 uppercase tracking-wide mb-4">
            ON THIS PAGE
        </p>
        <nav class="space-y-3">
            <a href="#Career-path"
                ...
                <span
                    class="w-6 h-6 rounded-full bg-crimson_red text-white flex items-center justify-center text-xs font-bold mr-3 text-dark">1</span>
                Career Path
            </a>
            <a href="#Recommended-Career-Paths"
                class="flex items-center text-sm text-gray-700 hover:text-gray-800 hover:font-semibold transition-all duration-200 py-2 px-3 rounded-lg hover:bg-gray-50">
                <span
                    class="w-6 h-6 rounded-full bg-crimson_red text-white flex items-center justify-center text-xs font-bold mr-3 text-dark">2</span>
                Recommended Careers
            </a>
            <a href="#Personality-Traits"
                class="flex items-center text-sm text-gray-700 hover:text-gray-800 hover:font-semibold transition-all duration-200 py-2 px-3 rounded-lg hover:bg-gray-50">
                <span
                    class="w-6 h-6 rounded-full bg-crimson_red text-white flex items-center justify-center text-xs font-bold mr-3 text-dark">3</span>
                Personality Traits
            </a>
            <a href="#Personality-Type"
                class="flex items-center text-sm text-gray-700 hover:text-gray-800 hover:font-semibold transition-all duration-200 py-2 px-3 rounded-lg hover:bg-gray-50">
                <span
                    class="w-6 h-6 rounded-full bg-crimson_red text-white flex items-center justify-center text-xs font-bold mr-3 text-dark">4</span>
                Personality Type
            </a>
        </nav>
    </div>
    ...
    <div class="space-y-3">
        ...
        <a href="quizPage.php"
            class="block w-full px-6 py-3 bg-navy_blue text-white hover:text-white font-bold text-sm rounded-xl hover:bg-blue-600 transition-all duration-300 shadow-lg text-center transform hover:scale-105">
...
<div id="mobile-menu" class="mobile-menu fixed top-0 right-0 h-full w-80 z-50 lg:hidden no-print overflow-y-auto">
    <div class="p-6">
        <!-- Close Button -->
        ...
        <div class="mb-6">
            <div class="flex items-center mb-4">
                <div class="w-12 h-12 rounded-full bg-lime flex items-center justify-center mr-4 shadow-lg">
                ...
                <div>
                    ...
                    <h3 class="text-lg font-bold text-gray-800" id="mobile-personality-type">
                        INTP
                    </h3>
